...
namespace CommuterDestination.Core.Graph
{
    ...
    public class DestinationGraphStop
    {
        ...
        {
            this.stopId = stopId;
            this.position = GameBridge.Instance.GetStopPosition(stopId);
        }
        ...
        public void AddJourney(ushort buildingId)
        {
            ...
            {
                var journey = new DestinationGraphJourney(this, buildingId, GameBridge.Instance.GetBuildingPosition(buildingId));
